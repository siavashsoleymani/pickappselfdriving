...
public class CommandSenderImpl implements CommandSenderService {
  ...
  public CommandSenderImpl(SpeedControlService speedControlService, SteeringControlService steeringControlService) {
    this.speedControlService = speedControlService;
    this.steeringControlService = steeringControlService;
  }

  public void sendCommand(String command) {
    if (!command.equalsIgnoreCase("w") && !command.equalsIgnoreCase("s") && !command.equalsIgnoreCase(" ") && !command.equalsIgnoreCase("q") && !command.equalsIgnoreCase("e")) {
      if (!command.equalsIgnoreCase("a") && !command.equalsIgnoreCase("d") && !command.equalsIgnoreCase("f")) {
